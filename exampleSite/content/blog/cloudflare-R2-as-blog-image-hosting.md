...
![](https://img.14says.xyz/2025/09/cloudflare-dashboard-R2.png)



创建 bucket

![](https://img.14says.xyz/2025/09/cloudflare-create-bucket.png)

输入 Bucket name，点击 `create bucket`完成创建

![](https://img.14says.xyz/2025/09/cloudflare-create-bucket-name.png)

创建完成之后，在设置中绑定一个自定义域名，可以使用已经由 cloudflare 管理的域名的子域名，我在这里用了博客域名的子域名。

![](https://img.14says.xyz/2025/09/cloudflare-bucket-custom-domains.png)

创建完成之后效果如图，就可以通过网络访问这个 Bucket 里的资源了。

![](https://img.14says.xyz/2025/09/cloudflare-bucket-custom-domains-added.png)
