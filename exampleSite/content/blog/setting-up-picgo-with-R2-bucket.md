...
上次在 [把Cloudflare R2 Bucket 作为博客图床](https://14says.xyz/2025/09/09/cloudflare-R2-as-blog-image-hosting/) 中记录了图片托管方案的变更，切换到这个方案之后图片的载入速度确实有了质的提升，不过写作过程中直接在 R2 Bucket 页面上上传图片、获取链接非常不方便，所以需要用到 [PicGo](https://github.com/Molunerfinn/PicGo) 这个软件来优化图片上传的流程。
...
![](https://img.14says.xyz/2025/09/1757767926-picgo-plugin-dashboard.png)
...
![](https://img.14says.xyz/2025/09/1757769099-r2-manage-api-tokens.png)

进去之后，点击右侧的 `Create Account API token`。

![](https://img.14says.xyz/2025/09/1757769294-r2-create-api-token.png)

进入之后设置一个 Token name，权限选择读写，然后指定要使用的 Bucket ，最后点击右下角的`Create Account API token`。

![](https://img.14says.xyz/2025/09/1757769491-r2-create-account-api-token.png)
...
![](https://img.14says.xyz/2025/09/1757771712-r2-account-api-token-keys.png)
...
![](https://img.14says.xyz/2025/09/1757768517-s3-plugin-setting-1.png)

![](https://img.14says.xyz/2025/09/1757770319-s3-plugin-setting-2.png)
...
![](https://img.14says.xyz/2025/09/1757771014-r2-pic-timestamp.png)
